...
class MainWindow(QMainWindow):
    def __init__(self, loggedUser: User):
        ...
        self.editOption = TablePTWs.MenuOption('Edit', self.editPTW)
        self.viewOption = TablePTWs.MenuOption('View', self.viewPTW)
        self.requestPTWOption = TablePTWs.MenuOption('Re-Request PTW', self.requestPTW)
        self.dltOption  = TablePTWs.MenuOption('Delete', self.deletePTW)
        self.runRequestOption  = TablePTWs.MenuOption('Run', self.requestToRunPTW)
        self.runAcceptOption  = TablePTWs.MenuOption('Run', self.runAcceptTW)
        self.runRejectOption  = TablePTWs.MenuOption('Reject', self.runRejectTW)
        self.clsRequestOption  = TablePTWs.MenuOption('Close', self.requestToClsPTW)
        self.clsAcceptOption  = TablePTWs.MenuOption('Close', self.clsAcceptPTW)
        self.clsRejectOption  = TablePTWs.MenuOption('Reject', self.clsRejectPTW)
        self.hldRequestOption  = TablePTWs.MenuOption('Hold', self.requestToHldPTW)
        self.hldTakeActionOption = TablePTWs.MenuOption('Take Action', self.hldTakeAction)
        self.tstRequestOption  = TablePTWs.MenuOption('Suction for Test', self.requestToSuctionTestPTW)
        self.tstAcceptOption  = TablePTWs.MenuOption('Suction for Test', self.suctionTestAcceptPTW)
        self.tstRejectOption  = TablePTWs.MenuOption('Reject', self.suctionTestRejectPTW)
        self.requestEditsOption = TablePTWs.MenuOption('Request Edits', self.requestEdits)
        self.acceptOption = TablePTWs.MenuOption('Accept', self.acceptPTW)
        self.rejectOption = TablePTWs.MenuOption('Reject', self.rejectPTW)
        self.printOption = TablePTWs.MenuOption('Print', self.printPTW)
        self.printDeIsolationOption = TablePTWs.MenuOption('Print De-Isolation', self.printDeIsolation)
        self.viewIsolationsOption = TablePTWs.MenuOption('View Isolations', self.viewIsolations)
        self.viewApprovalsOption = TablePTWs.MenuOption('View Approvals', self.viewApprovals)
        self.viewRequestorOption = TablePTWs.MenuOption('View Requestor', self.viewRequestor)
        self.viewPerformingOption = TablePTWs.MenuOption('View PA', self.viewPerforming)
        self.viewIssuingOption = TablePTWs.MenuOption('View PA', self.viewIssuing)
